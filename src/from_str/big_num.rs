...
pub(super) struct Decimal {
    ...
    pub(super) digits: [u8; MAX_DIGITS],
}
...
impl Decimal {
    ...
    pub(super) fn left_shift(&mut self, n: u32) {
    ...
    pub(super) fn right_shift(&mut self, n: u32) {
        debug_assert!(n <= Self::MAX_SHIFT);
        let mut read_idx = 0;
        let mut write_idx = 0;
    ...
    pub(super) fn round(&mut self) -> u256 {

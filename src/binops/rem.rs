...
use crate::{
    ...
    big_uint::{u256, DivRem},
    exp_bits, f256, norm_bit, norm_signif, sign_bits_hi, signif, FRACTION_BITS,
    HI_EXP_MASK, HI_FRACTION_BITS, MAX_HI, SIGNIFICAND_BITS,
};

#[inline]
fn rem_signifs(x: &u256, y: &u256, n_bits: u32) -> u256 {
    debug_assert!(x > y);
...
pub(crate) fn rem(x: f256, y: f256) -> f256 {
    ...
    let mut abs_bits_z = rem_signifs(&signif_x, &signif_y, n_bits);

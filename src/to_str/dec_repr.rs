...
impl DecNumRepr {
    ...
    pub(super) fn from_f256_shortest(f: &f256) -> Self {
        ...
        if exp2 >= 0 {
            ...
            // exp2 >= 0 => g >= 0
            // signif10 and its lower and upper bounds have atmost 226 bits
            // (237 + 501 - 512).
            // g > 98 => 5ᵍ > 2²²⁶ => signif10 and its bounds can't be a
            // multiple of 5ᵍ.
            if g <= 98 {
        ...
        // this interval.
        let mut i = 0_i32;
        let (mut quot, mut round_digit) = signif10.divmod_pow10(1);
        let (mut lower_quot, mut lower_rem) = lower_signif10.divmod_pow10(1);
        let (mut upper_quot, mut upper_rem) = upper_signif10.divmod_pow10(1);
        while lower_quot < upper_quot {
            signif10 = quot;
            lower_signif10 = lower_quot;
            upper_signif10 = upper_quot;
            (quot, round_digit) = signif10.divmod_pow10(1);
        ...
        assert_eq!(
            ...
            DecNumRepr {
                ...
                signif10: u256::new(
                    ...
                    168794288209602616731974382256735511566
                )
            }
        )
    }
